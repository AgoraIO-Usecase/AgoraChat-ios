//
//  AgoraChatSearchViewController.m
//  ChatDemo-UI3.0
//
...
@interface AgoraChatSearchViewController ()

@end

@implementation AgoraChatSearchViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.searchBar = [[AgoraChatSearchBar alloc] init];
...
#pragma mark - AgoraChatSearchBarDelegate
...
- (void)searchBarSearchButtonClicked:(AgoraChatSearchBar *)searchBar
{
