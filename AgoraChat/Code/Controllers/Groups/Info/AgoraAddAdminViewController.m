...
@interface AgoraAddAdminViewController ()
...
@implementation AgoraAddAdminViewController
...
- (void)_setupNavigationBar
{
    ...
    [doneButton addTarget:self action:@selector(editAction) forControlEvents:UIControlEventTouchUpInside];
