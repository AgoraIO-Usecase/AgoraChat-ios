//
//  AgoraChatSearchResultController.m
//  DXStudio
//
...
@interface AgoraChatSearchResultController ()<UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate>

@end

@implementation AgoraChatSearchResultController
