...
- (void)completeAction
{
    if(self.selectedItem) {
        ...
        if(cell) {
            ...
            [[[AgoraChatClient sharedClient] userInfoManager] updateOwnUserInfo:cell.strUrl withType:AgoraChatUserInfoTypeAvatarURL completion:^(AgoraChatUserInfo*aUserInfo,AgoraChatError *aError) {
                if(!aError) {
