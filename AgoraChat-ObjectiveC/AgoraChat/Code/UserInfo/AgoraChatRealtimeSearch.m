...
static AgoraChatRealtimeSearch *defaultUtil = nil;

@interface AgoraChatRealtimeSearch()
...
@implementation AgoraChatRealtimeSearch
...
+ (instancetype)shared
{
    ...
    dispatch_once(&onceToken, ^{
        defaultUtil = [[AgoraChatRealtimeSearch alloc] init];
    });
